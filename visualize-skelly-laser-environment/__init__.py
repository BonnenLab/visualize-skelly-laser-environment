...
__package_name__ = "visualize-skelly-laser-environment"
__version__ = "v0.1.0"

__author__ = """BonnenLab"""
...
from visualize-skelly-laser-environment.system.default_paths import get_log_file_path
from visualize-skelly-laser-environment.system.logging_configuration import configure_logging
